...
editContent=function(id){
  ...
  if(c.type==='Audio'){const grid=panel.querySelector('.form-grid');if(grid&&!grid.querySelector('[data-audio-kind=edit]'))grid.insertAdjacentHTML('beforeend',audioKindField(window.canonicalAudioKind?.(c)||'','edit'));}
