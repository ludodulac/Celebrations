...
function renderLibrary(){
  ...
  const list=imageItems||state.contents.filter(libraryMatches).slice().sort((a,b)=>publicLibraryName(a).localeCompare(publicLibraryName(b),'fr',{sensitivity:'base',numeric:true}));
