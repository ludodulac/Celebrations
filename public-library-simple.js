...
@media(max-width:850px){body.public-app{height:auto;min-height:100dvh;overflow-x:hidden;overflow-y:auto}body.public-app .container{overflow:visible;min-height:auto}body.public-app #library:not(.hidden){display:block;overflow:visible!important}.library-scroll{min-height:auto;overflow:visible;overscroll-behavior:auto;padding-right:0}.library-main-tabs{grid-template-columns:repeat(2,minmax(0,1fr));gap:5px}.library-main-tabs .btn{font-size:.7rem;padding:7px 5px;min-height:38px}.library-audio-tabs{gap:5px}.library-audio-tabs .chip{font-size:.7rem;padding:6px 9px}.simple-library-card{padding:12px}.simple-library-card h3{font-size:.95rem;margin:5px 0}.simple-library-card .muted{font-size:.78rem;margin:5px 0}.simple-library-card.has-library-visual{display:block}.simple-library-visual{width:100%;aspect-ratio:auto}.library-thumb{width:100%;height:auto;max-height:180px;aspect-ratio:auto;object-fit:contain;margin-bottom:10px}.content-fallback-thumb.library-thumb{height:120px!important;aspect-ratio:auto!important}.content-event-meta{font-size:.72rem}}
`;
