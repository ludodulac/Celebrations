(function(){
  ...
  function fallbackIcon(kind){
    if(kind==='music')return '<span class="fallback-glyph fallback-music" aria-hidden="true">♪</span>';
